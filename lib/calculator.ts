...
export function getInterpretation(): string {
  return "This predicted probability is generated by the adjusted logistic regression model. It is a proof-of-concept research estimate and must not be interpreted as a diagnostic, prognostic, or treatment threshold.";
}
